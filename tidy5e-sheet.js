...
export class Tidy5eSheet extends ActorSheet5eCharacter {
	...
	get template() {
		if ( !game.user.isGM && this.actor.limited ) return "modules/tidy5e-sheet2/templates/tidy5e-sheet-ltd.html";
		return "modules/tidy5e-sheet2/templates/tidy5e-sheet.html";
	}
